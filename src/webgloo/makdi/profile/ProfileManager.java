...
import webgloo.makdi.processor.SmallSiteProcessor;
...
public class ProfileManager {
    ...
    private static void process(IContentProfile profileBean) throws Exception {
        ...
        } else if (profileBean.getName().equals(IContentProfile.SMALL_SITE)) {
            new SmallSiteProcessor().invoke(profileBean);
        } else {
